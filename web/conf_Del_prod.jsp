            ...
            <div class="row mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Esta seguro de que quiere eliminar el producto. Una vez hecho esto ya no se podra recuperar</p>
                        <a href="stock.jsp" class="btn btn-primary">Regresar</a>
                        <form action="DProductosController" method="post">
                            <%
                                String Id_dprod = request.getParameter("Id_dprod");
                            %>
                            <input type="hidden" value="<%= Id_dprod%>" name="id_dprod"/>
                            <input type="hidden" value="borrarProd" name="command"/>
                            <button class="btn btn-danger m-3 btn2" type="submit">Borrar Producto</button>
                        </form>
                    </div>
                </div>
            </div>
