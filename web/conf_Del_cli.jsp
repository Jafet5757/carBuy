            ...
            <div class="row mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Esta seguro de que quiere borrar su cuenta. Una vez hecho esto ya no se podra recuperar</p>
                        <a href="account.jsp" class="btn btn-primary">Regresar</a>
